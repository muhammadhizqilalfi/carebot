...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFB] font-sans overflow-hidden">
      ...
      {/* ================= SIDEBAR GLOBAL ================= */}
      <aside className="w-[280px] bg-white border-r border-gray-100 flex flex-col justify-between shrink-0 z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        
        <div className="flex flex-col h-full">
          {/* Header Sidebar */}
          <div className="p-8 pb-6">
            <Link href="/dashboard" className="block w-fit">
              <h1 className="text-2xl font-extrabold text-[#0B7A7D] hover:opacity-80 transition-opacity">CareBot</h1>
            </Link>
          ...
          <div className="px-8 flex items-center gap-3 mb-8">
            ...
            <div>
              <p className="text-[15px] font-bold text-gray-800">Health Profile</p>
